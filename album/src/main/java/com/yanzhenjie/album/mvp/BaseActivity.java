...
public class BaseActivity extends AppCompatActivity implements Bye {
    ...
    public static final String[] PERMISSION_TAKE_PICTURE_30 = {"android.permission.CAMERA", "android.permission.READ_EXTERNAL_STORAGE"};
    ...
    public static final String[] PERMISSION_STORAGE_30 = {"android.permission.READ_EXTERNAL_STORAGE"};
